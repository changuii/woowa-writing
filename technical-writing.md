...
## 목차
- [festabook 동시성 문제, 이렇게 막았다!](#festabook-동시성-문제-이렇게-막았다)
  - [들어가며](#들어가며)
  - [목차](#목차)
  - [festabook에서 발생했던 동시성 문제](#festabook에서-발생했던-동시성-문제)
    - [핀 상태의 공지 만들기](#핀-상태의-공지-만들기)
    - [동시성 문제 재현](#동시성-문제-재현)
  - [festabook에서 선택한 동시성 문제 해결 방법](#festabook에서-선택한-동시성-문제-해결-방법)
    - [요약 비교](#요약-비교)
    - [넥스트키 락](#넥스트키-락)
    - [네임드 락](#네임드-락)
    - [분산락](#분산락)
    - [festabook의 선택](#festabook의-선택)
  - [festabook의 인메모리 락 구현](#festabook의-인메모리-락-구현)
    - [구현 목록](#구현-목록)
    - [LockAspect](#lockaspect)
      - [SpEL이란?](#spel이란)
      - [왜 락이 트랜잭션이 종료된 후 반납해야할까?](#왜-락이-트랜잭션이-종료된-후-반납해야할까)
    - [Lockable](#lockable)
    - [LockStorage](#lockstorage)
    - [Lock](#lock)
    - [InMemoryLockStorage](#inmemorylockstorage)
  - [festabook의 동시성 테스트](#festabook의-동시성-테스트)
  - [마무리](#마무리)
        - [출처](#출처)
